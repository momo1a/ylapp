...
$(function(){
    ...
    initFileInput("gene_img", "/gene/packageAdd",350,350);
    initFileInput("gene_img_edit", "/gene/packageAdd",350,350);
...
function editPackagePre(e){
    ...
    $.ajax({
        url: SITE_URL + "gene/getPackageDetail",
        type: "post",
        data:{pid:pid},
        dataType: 'json',
        success: function (result) {
