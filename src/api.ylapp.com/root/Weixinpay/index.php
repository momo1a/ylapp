...
<body>
	<div align="center">
        <ul>
            <li style="background-color:#FF7F24"><a href="http://123.207.87.83:8080/Weixinpay/example/jsapi.php">JSAPI支付</a></li>
            <li style="background-color:#698B22"><a href="http://paysdk.weixin.qq.com/example/micropay.php">刷卡支付</a></li>
            <li style="background-color:#8B6914"><a href="http://123.207.87.83:8080/Weixinpay/example/native.php">扫码支付</a></li>
