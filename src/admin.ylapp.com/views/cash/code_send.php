  ...
  <div class="ui-box-outer">
    <div class="ui-box-inner">
      <ul class="ui-tab-nav" id="tabs">
        ...
        <li class="ui-tab-item ui-tab-itemCurrent"><a href="<?php echo site_url('cash/index/code_send');?>">兑换码发放</a></li>
      ...
      <div class="ui-box ui-box2 advertisement-add">
        ...
        <form id="cash_send_form" type="ajax" callback="reload" method="post" action="<?php echo site_url('cash/code_send')?>" enctype="multipart/form-data">
          <ul>
            <li><span>现金券类型:</span>
...
!function($form){
    ...
    // 提交表单
    $("#cash_send_form").submit(function(){
        var $this = $(this);
