...
// 签名证书路径
const SDK_SIGN_CERT_PATH = '/mnt/myweb/yl/ylapp/src/common/libraries/union/certs/acp_test_sign.pfx';

// 签名证书密码
const SDK_SIGN_CERT_PWD = '000000';

// 商户号(目前测试商户号，生产环境更换为真实的商户号)
const  SDK_MER_ID = '777290058110048';

// 密码加密证书（这条一般用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = '/mnt/myweb/yl/ylapp/src/common/libraries/union/certs/acp_test_enc.cer';

// 验签证书路径（请配到文件夹，不要配到具体文件）
const SDK_VERIFY_CERT_DIR = '/mnt/myweb/yl/ylapp/src/common/libraries/union/certs/';
