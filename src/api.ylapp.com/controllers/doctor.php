...
class Doctor extends MY_Controller
{
    ...
    public function getDoctorList(){
        ...
        $this->load->model('user_model','user');
        $res = $this->user->getDoctorList(500,'YL_user.uid,YL_user.avatar,YL_user.nickname,YL_hospital.name AS hospitalName,YL_doctor_offices.officeName,YL_hospital.address,YL_doctor_info.goodAt',$officeId,$hid,$keyword);
