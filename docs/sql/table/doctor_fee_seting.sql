...
CREATE TABLE `YL_doctor_fee_seting` (
  ...
  `phoneFeeFirst` DECIMAL(9,2) unsigned not null default '0' comment '电话问诊一费用',
  `phonePerFirst` DECIMAL(5,2) unsigned not null default '0' comment '电话问诊一平台分成',
  ...
  `phonePerThird` DECIMAL(5,2) unsigned not null default '0' comment '电话问诊三平台分成',
