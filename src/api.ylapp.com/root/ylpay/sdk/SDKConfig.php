...
// 签名证书路径
const SDK_SIGN_CERT_PATH = '/mnt/myweb/yl/ylapp/src/api.ylapp.com/root/ylpay/certs/acp_test_sign.pfx';
...
// 前台通知地址 (商户自行配置通知地址)
const SDK_FRONT_NOTIFY_URL = 'http://localhost:8085/ylpay/demo/api_01_gateway/FrontReceive.php';

// 后台通知地址 (商户自行配置通知地址，需配置外网能访问的地址)
const SDK_BACK_NOTIFY_URL = 'http://222.222.222.222/ylpay/demo/api_01_gateway/BackReceive.php';

//文件下载目录 
const SDK_FILE_DOWN_PATH = '/var/logs/file/';

//日志 目录 
const SDK_LOG_FILE_PATH = '/var/logs/logs/';
