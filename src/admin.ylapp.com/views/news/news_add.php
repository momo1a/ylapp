        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" onclick="$('#newsAdd')[0].reset();CKEDITOR.instances.content.setData('');$('.fileinput-remove').trigger('click');">&times;</span></button>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-outline " data-dismiss="modal" onclick="$('#newsAdd')[0].reset();CKEDITOR.instances.content.setData('');$('.fileinput-remove').trigger('click');">取消</button>
