...
function saveSort(){
	...
	if (flag) {
		$.post(SITE_URL+"fenqi/sort", data, function(rs){
			if(AjaxFilter(rs)){
        ...
        <div class="ui-tab">
          <ul class="ui-tab-nav" id="tabs">
            <li class="ui-tab-item<?php if($get_type == 'ongoing'){echo ' ui-tab-itemCurrent';}?>">
            	<a href="<?php echo site_url('fenqi/ongoing');?>">正在进行</a></li>
            <li class="ui-tab-item<?php if($get_type == 'herald'){echo ' ui-tab-itemCurrent';}?>">
            	<a href="<?php echo site_url('fenqi/herald');?>">新品预告</a></li>
            <li class="ui-tab-item<?php if($get_type == 'complete'){echo ' ui-tab-itemCurrent';}?>">
            	<a href="<?php echo site_url('fenqi/complete');?>">已结算</a></li>
          </ul>
            ...
            <div id="RecommendList">
				...
				<div class="ui-box ui-box2">
					<div class="ui-box-head">
						<form rel="div#main-wrap" method="get" action="<?php echo site_url('fenqi/'.$get_type)?>">
							<span>活动搜索：</span>
