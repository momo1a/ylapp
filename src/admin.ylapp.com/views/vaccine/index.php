...
<?php $this->load->view('vaccine/package_add');?>
<?php $this->load->view('vaccine/package_edit');?>
<?php $this->load->view('vaccine/package_del');?>
                            ...
                            <?php if(!empty($list)){;?>
                                <?php foreach($list as $value){?>
                                    <tr>
                                        ...
                                        <th><?php switch(intval($value['type'])){
                                                case 1:
                                                    echo '儿童';
                                                    break;
                                                case 2:
...
<script src="<?php echo config_item('domain_static').'admin/';?>js/vaccine/vaccine.js"></script>