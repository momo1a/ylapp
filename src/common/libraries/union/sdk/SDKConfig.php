...
// 签名证书路径
//const SDK_SIGN_CERT_PATH = '/mnt/myweb/ylapp/src/common/libraries/union/certs/acp_test_sign.pfx';
const SDK_SIGN_CERT_PATH = '/usr/local/nginx/html/ylapp/src/common/libraries/union/certs/acp_test_sign.pfx';

// 签名证书密码
const SDK_SIGN_CERT_PWD = '000000';

// 商户号(目前测试商户号，生产环境更换为真实的商户号)
const  SDK_MER_ID = '826440153990003';

// 密码加密证书（这条一般用不到的请随便配）
//const SDK_ENCRYPT_CERT_PATH = '/mnt/myweb/ylapp/src/common/libraries/union/certs/acp_test_enc.cer';
const SDK_ENCRYPT_CERT_PATH = '/usr/local/nginx/html/ylapp/src/common/libraries/union/certs/acp_test_enc.cer';
...
//文件下载目录 
const SDK_FILE_DOWN_PATH = '/usr/local/nginx/html/ylapp/src/common/libraries/union/files/';

//日志 目录 
const SDK_LOG_FILE_PATH = '/usr/local/nginx/html/ylapp/src/common/libraries/union/logs/';
