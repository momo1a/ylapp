            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a data-target="#doctor_add" data-toggle="modal" onclick="addDoctorPre();"><h3 class="box-title" style="float: right;cursor: pointer"><span class="glyphicon glyphicon-save"></span>导出excel</h3></a>
                    </div>
