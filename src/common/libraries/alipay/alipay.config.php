...
$alipay_config['partner']		= '2088311771079114';
...
$alipay_config['notify_url'] = "http://123.207.87.83:8080/alipay/notify_url.php";

// 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
$alipay_config['return_url'] = "http://123.207.87.83:8080/alipay/return_url.php";
